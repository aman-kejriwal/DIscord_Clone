...
export const ServerSection=({
    ...
    return (
        <div className="flex items-center justify-between py-2 px-2 hover:bg-zinc-700/10 transition">
            <p className="text-[15px] text-zinc-500 dark:text-zinc-400 uppercase font-semibold">
                {label}
            </p>
            ...
            {role!==MemberRole.ADMIN && selectionType=="members"&&(
                <ActionTooltip label="Channel Settings" side={"top"} align={"start"}>
                    <button
                    onClick={()=>onOpen("createChannel",{})}
